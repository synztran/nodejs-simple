...
function handleUpload(c, f) {
	 console.log(10);
	 console.log(c); //details file upload
    ...
    for (var g = this, h = g.options, j = g.field.listInput, l = 0; l < c.length; l++) {
        ...
        // console.log("g.field.listInput");console.log(g.field.listInput);
        // console.log("j.list");console.log(j.list);
    	console.log("j.list.indexOf(n)");console.log(j.list.indexOf(n));
