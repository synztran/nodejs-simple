        ...
        var check = await Account.find({ email: req.body.email }, async (err, docs) => {
            ...
            if (docs.length) {
                ...
                var mainOptions = {
                    ...
                    html: "<img src='"+logo+"' width='150' height='70'/><br><br><p style='font-family: 'Montserrat';font-weight: 600;font-size:22px'>Hi <b>"+req.body.lname+"</b>,</p><br><p style='font-family: 'Montserrat';font-size:18px'>We're happy you signed up for NoobStore.To finish registration, please confirm your email address.</p><br><p><div><a style='font-family: 'Montserrat';background: #007bff;padding: 9px;width: 200px;color: #fff;text-decoration: none;display: inline-block;font-weight: bold;text-align: center;letter-spacing: 0.5px;border-radius: 50px;font-size:20px' href=" + link + ">Verify now</a></div><br><p style='font-family: 'Montserrat';font-size:18px'>Welcome to NoobStore!</p><br><br><p style='font-family: 'Montserrat';font-size:18px'>Once verified, you can join and get notification from NoobStore. If you have any problems, please contact us: noobassembly@gmail.com</p></p>"
                }
